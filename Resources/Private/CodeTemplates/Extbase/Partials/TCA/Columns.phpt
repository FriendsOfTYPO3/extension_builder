...
$TCA['{domainObject.databaseTableName}']['columns'][$TCA['{domainObject.databaseTableName}']['ctrl']['type']]['config']['items'][] = array('LLL:EXT:{domainObject.extension.extensionKey}/Resources/Private/Language/locallang_db.xml:{domainObject.mapToTable}.tx_extbase_type.{domainObject.recordType}','{domainObject.recordType}');
</f:if>
...
$TCA['{domainObject.databaseTableName}']['types']['{domainObject.recordType}']['showitem'] .= ',--div--;LLL:EXT:{domainObject.extension.extensionKey}/Resources/Private/Language/locallang_db.xml:{domainObject.labelNamespace},';
