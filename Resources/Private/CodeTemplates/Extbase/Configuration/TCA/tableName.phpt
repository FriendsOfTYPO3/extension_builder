...
return [
    'ctrl' => [
        ...
        'searchFields' => '<f:for each="{domainObject.properties}" as="property">{property.fieldName}{f:if(condition: it.isLast, else: \',\')}</f:for>',
