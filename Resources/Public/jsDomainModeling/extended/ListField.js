      ...
      lang.extend(
         ...
         */
        {
          ...
          setValue: function (value, sendUpdatedEvt) {
            ...
            inputEx.ListField.superclass.setValue.call(
              this,
              value,
              sendUpdatedEvt,
            );
            ...
            if (typeof copiedFieldSet["inputs"] != "undefined") {
              for (i = 0; i < copiedFieldSet["inputs"].length; i++) {
                ...
                if (
                  ...
                  Dom.addClass(
                    fieldset,
                    copiedFieldSet["inputs"][i].getValue(),
                  );
          ...
          onArrowUp: function (e) {
            ...
            for (
              var i = 1;
              i < childElement.parentNode.childNodes.length;
              i++
            ) {
          ...
          onDelete: function (e) {
            ...
            var subFieldEl =
              elementDiv.childNodes[this.options.useButtons ? 1 : 0];
            for (var i = 0; i < this.subFields.length; i++) {
