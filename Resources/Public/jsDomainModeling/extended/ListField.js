...
(function() {
	...
	inputEx.messages.listAddLink = TYPO3.settings.extbaseKickstarter._LOCAL_LANG.add;
	inputEx.messages.listRemoveLink = TYPO3.settings.extbaseKickstarter._LOCAL_LANG.remove;
