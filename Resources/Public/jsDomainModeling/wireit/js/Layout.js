...
WireIt.Layout.Spring.prototype = {
  init: function () {
    ...
    for (var i = 0; i < this.layer.wires.length; i++) {
      ...
      this.edges.push([
        this.layer.containers.indexOf(wire.terminal1.container),
        this.layer.containers.indexOf(wire.terminal2.container),
      ]);
    }
  },
  ...
  run: function () {
    ...
    for (i = 0; i < this.layer.containers.length; i++) {
      node = this.nodes[i];
      newPositions.push([
        node.layoutPosX * 200 + 400 - 40,
        node.layoutPosY * 200 + 400 - 20,
      ]);
    }
    return newPositions;
  },
