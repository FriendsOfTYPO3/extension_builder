...
YAHOO.lang.extend(WireIt.Wire, WireIt.CanvasElement, {
  ...
  setOptions: function (options) {
    ...
    this.options.coeffMulDirection = YAHOO.lang.isUndefined(
      options.coeffMulDirection,
    )
      ? 100
      : options.coeffMulDirection;
  ...
  drawBezierCurve: function () {
    ...
    var d1 = [
      this.terminal1.options.direction[0] * coeffMulDirection,
      this.terminal1.options.direction[1] * coeffMulDirection,
    ];
    var d2 = [
      this.terminal2.options.direction[0] * coeffMulDirection,
  ...
  drawBezierArrows: function () {
    ...
    ctxt.bezierCurveTo(
      ...
      bezierPoints[3][0],
      bezierPoints[3][1] +
        (arrowLength / 2) * this.terminal2.options.direction[1],
    );
    ctxt.stroke();
  ...
  drawArrows: function () {
    ...
    var min = [
      Math.min(p1[0], p2[0]) - margin[0],
      Math.min(p1[1], p2[1]) - margin[1],
    ];
    var max = [
      Math.max(p1[0], p2[0]) + margin[0],
