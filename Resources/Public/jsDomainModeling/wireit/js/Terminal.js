(function () {
  ...
  WireIt.Scissors = function (terminal, oConfigs) {
    WireIt.Scissors.superclass.constructor.call(
      this,
  ...
  lang.extend(WireIt.Scissors, util.Element, {
    ...
    initScissors: function () {
      ...
      this.appendTo(
        this._terminal.container
          ? this._terminal.container.layer.el
          : this._terminal.el.parentNode.parentNode,
      );
    ...
    setPosition: function () {
      ...
      this.setStyle(
        "left",
        pos[0] + this._terminal.options.direction[0] * 30 - 8 + "px",
      );
      this.setStyle(
        "top",
        pos[1] + this._terminal.options.direction[1] * 30 - 8 + "px",
      );
    },
    /**
     * @method mouseOver
    ...
    show: function () {
      ...
      if (
        WireIt.Scissors.visibleInstance &&
  ...
  WireIt.TerminalProxy = function (terminal, options) {
    ...
    // Init the DDProxy
    WireIt.TerminalProxy.superclass.constructor.call(
      this,
      this.terminal.el,
      undefined,
      {
  ...
  lang.extend(WireIt.TerminalProxy, util.DDProxy, {
    ...
    startDrag: function () {
      ...
      if (
        this.terminal.options.nMaxWires == 1 &&
        this.terminal.wires.length == 1
      ) {
      ...
      this.fakeTerminal = {
        ...
        getXY: function () {
          ...
          if (layers.length > 0) {
            ...
            return [
              this.pos[0] - orig[0] + halfProxySize,
              this.pos[1] - orig[1] + halfProxySize,
            ];
          }
          return this.pos;
        },
      ...
      this.editingWire = new WireIt.Wire(
        this.terminal,
        this.fakeTerminal,
        parentEl,
    ...
    onDrag: function (e) {
      ...
      if (this.terminal.container) {
        ...
        this.fakeTerminal.pos = YAHOO.env.ua.ie
          ? [e.clientX, e.clientY]
    ...
    onDragDrop: function (e, ddTargets) {
      ...
      for (var i = 0; i < this.terminal.wires.length; i++) {
        if (this.terminal.wires[i].terminal1 == this.terminal) {
          if (
            this.terminal.wires[i].terminal2 == targetTerminalProxy.terminal
          ) {
          ...
          if (
            this.terminal.wires[i].terminal1 == targetTerminalProxy.terminal
          ) {
            termAlreadyConnected = true;
            break;
          }
      ...
      if (tgtTerm.options.nMaxWires == 1) {
        ...
        var w = new WireIt.Wire(
          term1,
          term2,
          parentEl,
          term1.options.wireConfig,
        );
        w.redraw();
    ...
    isValidWireTerminal: function (DDterminal) {
      ...
      if (this.termConfig.type) {
        if (this.termConfig.allowedTypes) {
          if (
            WireIt.indexOf(
              DDterminal.termConfig.type,
              this.termConfig.allowedTypes,
            ) == -1
          ) {
            return false;
          }
      ...
      // The other terminal may have type property too:
        ...
        if (DDterminal.termConfig.allowedTypes) {
          if (
            WireIt.indexOf(
              this.termConfig.type,
              DDterminal.termConfig.allowedTypes,
            ) == -1
          ) {
            return false;
          }
  ...
  WireIt.Terminal.prototype = {
    ...
    setOptions: function (options) {
      ...
      this.options.fakeDirection = options.fakeDirection || [
      ...
      this.options.connectedClassName =
        options.connectedClassName || CSS_PREFIX + "Terminal-connected";
      this.options.dropinviteClassName =
        options.dropinviteClassName || CSS_PREFIX + "Terminal-dropinvite";
      this.options.editable = lang.isUndefined(options.editable)
        ? true
        : options.editable;
      this.options.nMaxWires = options.nMaxWires || Infinity;
      this.options.wireConfig = options.wireConfig || {};
      this.options.editingWireConfig =
        options.editingWireConfig || this.options.wireConfig;
      this.options.offsetPosition = options.offsetPosition;
      this.options.alwaysSrc = lang.isUndefined(options.alwaysSrc)
        ? false
        : options.alwaysSrc;
    ...
    getXY: function () {
      var layerEl =
        this.container && this.container.layer
          ? this.container.layer.el
          : document.body;
  ...
  WireIt.util.TerminalInput = function (parentEl, options, container) {
    WireIt.util.TerminalInput.superclass.constructor.call(
      this,
      parentEl,
      options,
      container,
  ...
  WireIt.util.TerminalOutput = function (parentEl, options, container) {
    WireIt.util.TerminalOutput.superclass.constructor.call(
      this,
      parentEl,
      options,
      container,
