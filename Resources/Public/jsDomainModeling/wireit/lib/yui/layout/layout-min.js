  ...
  YAHOO.extend(B, YAHOO.util.Element, {
      ...
      if (!this._collapsing || F === true) {
        ...
        if (this._collapsed && !this._collapsing) {
          ...
          D.setStyle(
            this._clip,
            "top",
            this.get("top") + this._gutter.top + "px",
          );
          D.setStyle(
            this._clip,
            "left",
            this.get("left") + this._gutter.left + "px",
          );
        } else {
    ...
    _createClip: function () {
      if (!this._clip) {
        ...
        this._clip.className =
          "yui-layout-clip yui-layout-clip-" + this.get("position");
        ...
        switch (this.get("position")) {
          ...
          case "bottom":
            ...
            D.setStyle(
              this._clip,
              "left",
              this._lastLeft + this._gutter.left + "px",
            );
    ...
    collapse: function () {
      ...
      switch (K) {
        ...
        case "bottom":
          this.set(
            "height",
            this.get("collapseSize") + (this._gutter.top + this._gutter.bottom),
          );
        ...
        case "right":
          this.set(
            "width",
            this.get("collapseSize") + (this._gutter.left + this._gutter.right),
          );
    ...
    initAttributes: function (F) {
      ...
      this.setAttributeConfig("collapse", {
        ...
        method: function (G) {
          ...
          if (G) {
            ...
            H.className =
              "collapse" + (this.get("close") ? " collapse-close" : "");
          } else {
            if (H) {
              A.purgeElement(H);
              H.parentNode.removeChild(H);
      ...
      this.setAttributeConfig("scroll", {
        value:
          F.scroll === true || F.scroll === false || F.scroll === null
            ? F.scroll
            : false,
        method: function (G) {
    ...
    toString: function () {
      if (this.get) {
        return (
          "LayoutUnit #" + this.get("id") + " (" + this.get("position") + ")"
        );
      }
      return "LayoutUnit";
    },
