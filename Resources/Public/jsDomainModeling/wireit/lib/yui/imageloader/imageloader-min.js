...
YAHOO.util.ImageLoader.group.prototype.registerSrcImage = function (
  D,
  B,
  C,
  A,
...
YAHOO.util.ImageLoader.pngBgImgObj.prototype._applyUrl = function (B) {
  if (YAHOO.env.ua.ie && YAHOO.env.ua.ie <= 6) {
    var C = YAHOO.lang.isUndefined(this.props.sizingMethod)
      ? "scale"
      : this.props.sizingMethod;
    var A = YAHOO.lang.isUndefined(this.props.enabled)
      ? "true"
      : this.props.enabled;
    B.style.filter =
