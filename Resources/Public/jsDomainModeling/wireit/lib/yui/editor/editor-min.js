...
(function () {
  ...
  YAHOO.widget.Toolbar = function (I, H) {
    ...
    YAHOO.widget.Toolbar.superclass.constructor.call(
      this,
      J.element,
      J.attributes,
    );
  ...
  YAHOO.extend(YAHOO.widget.Toolbar, YAHOO.util.Element, {
      ...
      for (var G = 0; G < F.length; G++) {
        ...
        C.addClass(
          ...
          "yui-toolbar-" +
            ...
            (F[G].value
              ? F[G].value.replace(/ /g, "-")
              : F[G]._oText.nodeValue.replace(/ /g, "-")),
        );
      }
    },
    ...
    initAttributes: function (E) {
      ...
      this.setAttributeConfig("grouplabels", {
        ...
        method: function (F) {
          if (F) {
            C.removeClass(
              this.get("cont"),
              this.CLASS_PREFIX + "-nogrouplabels",
            );
          } else {
      ...
      this.setAttributeConfig("collapse", {
        ...
        method: function (H) {
          if (this._titlebar) {
            var G = null;
            var F = C.getElementsByClassName(
              "collapse",
              "span",
              this._titlebar,
            );
        ...
        method: function (F) {
          if (F && !this.get("titlebar")) {
            if (!this._dragHandle) {
              ...
              this._dragHandle.setAttribute(
                "title",
                "Click to drag the toolbar",
              );
    ...
    addButtonGroup: function (I) {
      ...
      for (var G = 0; G < I.buttons.length; G++) {
        ...
        H.appendChild(E);
        if (
          I.buttons[G].type !== undefined &&
          I.buttons[G].type == "separator"
        ) {
          this.addSeparator(E);
        } else {
      ...
      A.on(
        ...
        function (M) {
          ...
          if (I.tagName.toLowerCase() == "a") {
            ...
            J.innerHTML =
              this._colorData["#" + I.innerHTML] + "<br>" + I.innerHTML;
          }
        },
        this,
        true,
    ...
    _makeColorButton: function (E) {
      ...
      E.type = "color";
      E.menu = new YAHOO.widget.Overlay(
        this.get("id") + "_" + E.value + "_menu",
        {
          visible: false,
          position: "absolute",
          iframe: true,
      ...
      E.menu.beforeShowEvent.subscribe(
        function () {
          ...
          E.menu.cfg.setProperty("context", [
            this.getButtonById(E.id).get("element"),
            "tl",
            "bl",
          ]);
      ...
      switch (F.keyCode) {
        ...
        case 39:
          ...
          if (this._buttonList[this._navCounter]) {
            ...
            if (this.browser.ie) {
              E = this._buttonList[this._navCounter]
                .get("element")
...
(function () {
  ...
  YAHOO.extend(YAHOO.widget.SimpleEditor, YAHOO.util.Element, {
    ...
    _setupResize: function () {
      ...
      if (this.get("resize")) {
        ...
        this.resize = new YAHOO.util.Resize(
            ...
            if (this.get("iframe").get("element")) {
              try {
                if (this.get("iframe").get("element").contentWindow) {
                  if (
                    this.get("iframe").get("element").contentWindow.document
                  ) {
                    E =
                      this.get("iframe").get("element").contentWindow.document;
                    return E;
    ...
    _toggleDesignMode: function () {
      var F = this._getDoc().designMode.toLowerCase(),
        E = "on";
      if (F == "on") {
        E = "off";
      }
    ...
    _setInitialContent: function () {
      ...
      var F = D.substitute(this.get("html"), {
          TITLE: this.STR_TITLE,
          CONTENT: this._cleanIncomingHTML(H),
          CSS: this.get("css"),
      ...
      if (
        ...
        this.get("iframe").get("element").src =
          "data:text/html;charset=utf-8," + encodeURIComponent(F);
      }
      ...
      for (var E = 0; E < K.length; E++) {
        ...
        if (!C.hasClass(K[E], "yui-non")) {
          if (C.hasClass(K[E], "yui-tag")) {
            ...
            G =
              K[E].className !== ""
                ? "." + K[E].className.replace(/ /g, ".")
                : "";
            if (
              G.indexOf("yui") != -1 ||
              G.toLowerCase().indexOf("apple-style-span") != -1
            ) {
              G = "";
            }
            L = M + (K[E].id ? "#" + K[E].id : "") + G;
    ...
    _handleKeyUp: function (G) {
      ...
      switch (G.keyCode) {
        ...
        case this._keyMap.CLOSE_WINDOW.key:
          if (
            G.keyCode == this._keyMap.CLOSE_WINDOW.key &&
            this.currentWindow
          ) {
    ...
    _listFix: function (K) {
      ...
      if (
        ...
        ((!this.browser.webkit3 && K.keyCode == 25) ||
          ((this.browser.webkit3 || !this.browser.webkit) &&
            K.keyCode == 9 &&
            K.shiftKey))
      ) {
      ...
      if (K.keyCode && K.keyCode == 9 && !K.shiftKey) {
        ...
        if (this._hasParent(M, "li")) {
          ...
          var J = this._getDoc().createElement(
      ...
      if (!this.get("disabled")) {
        if (this.STOP_NODE_CHANGE) {
          ...
          if (
            I &&
            this.currentWindow &&
            this.currentWindow.name == "insertimage"
          ) {
    ...
    _handleAfterNodeChange: function () {
      ...
      if (J) {
        for (var O = 0; O < J._configs.menu.value.length; O++) {
          if (
            H &&
            J._configs.menu.value[O].text.toLowerCase() == H.toLowerCase()
          ) {
            F = true;
      ...
      if (this.browser.webkit) {
        if (this._isElement(Z, "li") && this._isElement(Z.parentNode, b)) {
          ...
          for (M = 0; M < this.currentElement.length; M++) {
            ...
            J.innerHTML =
              this.currentElement[M].innerHTML +
              '<span class="yui-non">&nbsp;</span>&nbsp;';
            X.appendChild(J);
            if (M > 0) {
              this.currentElement[M].parentNode.removeChild(
        ...
        if (
          (this._isElement(G, "li") && this._isElement(G.parentNode, b)) ||
          (this.browser.ie &&
            this._isElement(this._getRange().parentElement, "li")) ||
    ...
    cmd_fontsize: function (H) {
      ...
      if (G) {
        if (
          !this._isElement(this._getSelectedElement(), "body") &&
          !this._hasSelection()
        ) {
          E = this._getSelectedElement();
          YAHOO.util.Dom.setStyle(E, "fontSize", H);
  ...
  YAHOO.widget.EditorInfo = {
    ...
    toString: function () {
      ...
      return (
        "Editor Info (" + E + " registered intance" + (E > 1 ? "s" : "") + ")"
      );
    },
  };
})();
(function () {
  ...
  YAHOO.extend(YAHOO.widget.Editor, YAHOO.widget.SimpleEditor, {
    ...
    STR_CLOSE_WINDOW_NOTE:
      "To close this window use the Control + Shift + W key",
    ...
    _renderInsertImageWindow: function () {
      ...
      var L = document.createElement("div");
      L.className =
        "yui-toolbar-group yui-toolbar-group-height-width height-width";
      ...
      A.onAvailable(
        ...
        function () {
          A.on(
            ...
            function () {
              var O = parseInt(
                C.get(this.get("id") + "_insertimage_width").value,
                10,
              );
              if (O > 5) {
      ...
      A.onAvailable(
        ...
        function () {
          A.on(
            ...
            function () {
              var O = parseInt(
                C.get(this.get("id") + "_insertimage_height").value,
                10,
              );
              if (O > 5) {
            ...
            if (this.currentElement[0]) {
              ...
              if (Q && Q.value && Q.value != this.STR_IMAGE_HERE) {
                ...
                O.onerror = function () {
                  ...
                  YAHOO.util.Dom.get(
                    P.get("id") + "_insertimage_height",
                  ).value = O.height;
                  YAHOO.util.Dom.get(P.get("id") + "_insertimage_width").value =
                    O.width;
                };
                var R = this.get("id");
                window.setTimeout(function () {
                  YAHOO.util.Dom.get(R + "_insertimage_height").value =
                    O.height;
    ...
    _handleInsertImageClick: function () {
      ...
      this.on("afterExecCommand", function () {
        var H = this.currentElement[0],
          ...
          K = 0,
          T = false,
          J = new YAHOO.widget.EditorWindow("insertimage", { width: "415px" });
        if (!H) {
          H = this._getSelectedElement();
        }
        if (H) {
        ...
        var Z = G.getButtonByValue("bordersize"),
          X = parseInt(F, 10) > 0 ? "" : this.STR_NONE;
        Z.set(
          "label",
          '<span class="yui-toolbar-bordersize-' + F + '">' + X + "</span>",
        );
        this._updateMenuChecked("bordersize", F, G);
        var O = G.getButtonByValue("bordertype");
        O.set(
          "label",
          '<span class="yui-toolbar-bordertype-' + V + '">asdfa</span>',
        );
        ...
        if (parseInt(H.style.marginLeft, 10) > 0) {
          G.getButtonByValue("padding").set(
            "label",
            "" + parseInt(H.style.marginLeft, 10),
          );
        }
        ...
        C.get(this.get("id") + "_insertimage_target").checked = a
          ? true
          : false;
        ...
        if (S != N || W != K) {
          ...
          C.get(this.get("id") + "_insertimage_height").parentNode.appendChild(
            Q,
          );
        }
    ...
    _renderPanel: function () {
      ...
      H.style.left = "-9999px";
      document.body.appendChild(H);
      this.get("element_cont").insertBefore(
        H,
        this.get("element_cont").get("firstChild"),
      );
    ...
    moveWindow: function (F) {
      ...
      if (this._isElement(this.currentElement[0], "img")) {
        ...
        if (K && K.indexOf && K.indexOf("px") != -1) {
          Y[1] =
            Y[1] +
            parseInt(C.getStyle(this.currentElement[0], "fontSize"), 10) +
            5;
        } else {
          Y[1] = Y[1] + 20;
        }
      ...
      if (
        Y[0] + R * 2 >
        a[0] + parseInt(this.get("iframe").get("element").clientWidth, 10)
      ) {
        Y[0] =
          a[0] +
          parseInt(this.get("iframe").get("element").clientWidth, 10) -
          R * 2 -
          5;
        U = "right";
      }
      ...
      if (X > 10 || L > 10 || F) {
        ...
        if (F) {
          ...
          if (this.get("animate")) {
            ...
            var Z = new YAHOO.util.Anim(
              O.iframe,
              T.attributes,
              0.5,
              YAHOO.util.Easing.easeOut,
            );
            var E = new YAHOO.util.Anim(
              G,
              { left: { to: S } },
              0.6,
              YAHOO.util.Easing.easeOut,
    ...
    cmd_removeformat: function (H) {
      ...
      if (
        this.browser.webkit &&
        !this._getDoc().queryCommandEnabled("removeformat")
      ) {
        var E = this._getSelection() + "";
        this._createCurrentElement("span");
