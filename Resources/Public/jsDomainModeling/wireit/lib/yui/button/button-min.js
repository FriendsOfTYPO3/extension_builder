  ...
  YAHOO.extend(YAHOO.widget.Button, YAHOO.util.Element, {
    ...
    _onClick: function (Q) {
      ...
      switch (S) {
        ...
        case "split":
          if (
            this._nOptionRegionX > 0 &&
            M.getPageX(Q) > this._nOptionRegionX
          ) {
            P = false;
          } else {
            this._hideMenu();
    ...
    init: function (O, a) {
      var Q = a.type == "link" ? "a" : "button",
        V = a.srcelement,
        Z = O.getElementsByTagName(Q)[0],
        X;
      if (!Z) {
