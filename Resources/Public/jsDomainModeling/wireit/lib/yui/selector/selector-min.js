    ...
    _test: function (D, G, F, E) {
      ...
      if (F.attributes.length) {
        ...
        for (var I = 0, K; (K = F.attributes[I++]); ) {
          ...
          if (
            A.Selector.operators[K[1]] &&
            !A.Selector.operators[K[1]](B, K[2])
          ) {
            return false;
          }
        }
      ...
      if (F.pseudos.length) {
        for (var I = 0, J = F.pseudos.length; I < J; ++I) {
          if (
            A.Selector.pseudos[F.pseudos[I][0]] &&
            !A.Selector.pseudos[F.pseudos[I][0]](D, F.pseudos[I][1])
          ) {
            return false;
          }
        }
      }
      return F.previous && F.previous.combinator !== ","
        ? A.Selector._combinators[F.previous.combinator](D, F)
        : true;
    },
    filter: function (E, D) {
      E = E || [];
