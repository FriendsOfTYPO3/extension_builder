...
(function () {
  ...
  YAHOO.rpc.Service.prototype = {
    ...
    _generateService: function (serviceName, method) {
      ...
      var func = function (data, opts) {
          ...
          failure: function (o) {
            if (lang.isFunction(opts.failure)) {
              ...
              if (typeof o.error != "undefined") {
                errorMessage +=
                  'Response:<div style="width:360px;height:300px;overflow: scroll">' +
                  o.error +
                  "</div>";
              }
              if (typeof o.responseText != "undefined") {
                errorMessage +=
                  '<br /><a href="#" id="debugPopup" style="text-decoration: underline">Show response</a>';
        ...
        var params = {};
        if (
          self._smd.additionalParameters &&
          lang.isArray(self._smd.parameters)
        ) {
        ...
        var r = {
          ...
          opts: opts,
          callbackParamName:
            method.callbackParamName || self._smd.callbackParamName,
  ...
  YAHOO.rpc.Envelope = {
    ...
    PATH: {
      serialize: function (smd, method, data) {
        var target = method.target || smd.target,
          i;
