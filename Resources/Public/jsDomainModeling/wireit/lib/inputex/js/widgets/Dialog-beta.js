(function () {
  ...
  inputEx.widget.Dialog = function (options) {
    ...
    inputEx.widget.Dialog.superclass.constructor.call(
      this,
      this._inputExOptions.id,
      this._inputExOptions.panelConfig,
    );
  ...
  YAHOO.lang.extend(
     ...
     */
    {
       ...
       */
      buildForm: function () {
        this._inputExOptions.inputExDef.inputParams.parentEl =
          this._inputExBodyId;
