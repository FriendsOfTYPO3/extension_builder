(function () {
  ...
  inputEx.widget.DataTable = function (options) {
    ...
    this.options.parentEl = lang.isString(options.parentEl)
      ? Dom.get(options.parentEl)
      : options.parentEl;
    this.options.editing = this.options.editing || "formeditor";
    // + this.options.tableColumns
    this.options.sortable = lang.isUndefined(this.options.sortable)
      ? true
      : this.options.sortable;
    this.options.resizeable = lang.isUndefined(this.options.resizeable)
      ? true
      : this.options.resizeable;
    this.options.allowInsert = lang.isUndefined(this.options.allowInsert)
      ? true
      : this.options.allowInsert;
    this.options.allowModify = lang.isUndefined(this.options.allowModify)
      ? true
      : this.options.allowModify;
    this.options.allowDelete = lang.isUndefined(this.options.allowDelete)
      ? true
  ...
  inputEx.widget.DataTable.prototype = {
    ...
    renderDatatable: function () {
      ...
      if (this.options.allowInsert) {
        this.insertButton = inputEx.cn(
          "button",
          null,
          null,
          inputEx.messages.insertItemText,
        );
        Event.addListener(
          this.insertButton,
          "click",
    ...
    initFormEditor: function () {
      ...
      this.datatable.subscribe(
        "rowClickEvent",
        this.datatable.onEventSelectRow,
      );
      ...
      // Form container
      this.formContainer = inputEx.cn(
        "div",
        { className: "inputEx-DataTable-formContainer" },
        null,
        "&nbsp;",
      );
      ...
      this.options.parentEl.appendChild(
        inputEx.cn("div", null, { clear: "both" }),
      );
    },
    ...
    initCellEditor: function () {
      ...
      this.datatable.subscribe(
        "cellMouseoutEvent",
        this.datatable.onEventUnhighlightCell,
      );
    },
  ...
  inputEx.widget.InputExCellEditor = function (inputExFieldDef) {
    ...
    inputEx.widget.InputExCellEditor.superclass.constructor.call(
      this,
      "inputEx",
      { disableBtns: true },
    );
  ...
  lang.extend(
     ...
     */
    {
      ...
      renderForm: function () {
        ...
        this._inputExField.updatedEvt.subscribe(
          function (e, args) {
       ...
       */
      resetForm: function () {
        this._inputExField.setValue(
          lang.isValue(this.value) ? this.value.toString() : "",
        );
      },
