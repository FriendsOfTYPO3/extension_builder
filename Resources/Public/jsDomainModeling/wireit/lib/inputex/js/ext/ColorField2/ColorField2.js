  ...
  lang.extend(
     ...
     */
    {
      ...
      renderPopUp: function () {
        ...
        this.squaresOnLastLine =
          this.squaresPerLine -
          (this.squaresPerLine * this.squaresPerColumn - this.length);
        ...
        // create the popup
        this.colorPopUp = inputEx.cn(
          "div",
          { className: "inputEx-ColorField-popup" },
          {
            width: width + "px",
            display: "none",
          },
      ...
      renderColorGrid: function () {
        ...
        for (var i = 0; i < this.squaresPerColumn; i++) {
          ...
          for (var j = 0; j < this.cellPerLine; j++) {
            ...
            inputEx.sn(square, null, {
              backgroundColor: "#" + this.colors[i * this.cellPerLine + j],
              cursor: "pointer",
              margin: "10px",
            });
