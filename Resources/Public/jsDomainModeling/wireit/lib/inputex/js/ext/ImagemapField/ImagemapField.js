  ...
  lang.extend(
     ...
     */
    {
      ...
      renderComponent: function () {
        var orgimagesrc =
          this.options.orgimgsrc != null
            ? this.options.orgimgsrc
            : "/images/game/chinesechecker/chinesecheckergrid_fc_s.png";
        YAHOO.log(
          "renderComponent() - orgimgsrc: " + orgimagesrc,
          "info",
          "ImagemapField.js",
        );
        this.tgimgsrc =
          this.options.tgimgsrc != null
            ? this.options.tgimgsrc
            : "/images/game/chinesechecker/chinesecheckergrid_fc_s.png";
        YAHOO.log(
          "renderComponent() - tgimgsrc: " + this.tgimgsrc,
          "info",
          "ImagemapField.js",
        );
        this.tgmapcoords =
          this.options.tgmapcoords != null ? this.options.tgmapcoords : null;
        YAHOO.log(
          "renderComponent() - tgmapcoords: " +
            this.tgmapcoords +
            ", tgmapcoords.size: " +
            this.tgmapcoords.length,
          "info",
          "ImagemapField.js",
        );
        this.parent =
          this.options.parentEl != null ? this.options.parentEl : "";
        YAHOO.log(
          "renderComponent() - parent: " + this.parent,
          "info",
          "ImagemapField.js",
        );
        var log = "";
        ...
        YAHOO.log(
          "renderComponent() - tgmapcoords details: " + log,
          "info",
          "ImagemapField.js",
        );
      ...
      renderPopUp: function () {
        ...
        // create the popup
        this.imgmapPopUp = inputEx.cn(
          "div",
          { className: "inputEx-ImagemapField-popup" },
          {
            left: "100px",
            top: "100px",
            display: "none",
      ...
      renderImageMap: function () {
        ...
        for (var i = 0; i < this.tgmapcoords.length; i++) {
          ...
          YAHOO.log(
            "renderImageMap() - alt: " + imgmap[4],
            "info",
            "ImagemapField.js",
          );
          area.alt = imgmap[4] ? imgmap[4] : "";
          YAHOO.log(
            "renderImageMap() - " + area.id + "-area.coords: " + area.coords,
            "info",
            "ImagemapField.js",
          );
      ...
      onImageClick: function (e) {
        ...
        YAHOO.log(
          "ImagemapField.onImageClick, target:" + target.id + ", event: " + e,
          "info",
          "body",
        );
        ...
        YAHOO.log(
          "ImagemapField.onImageClick, targetid:" + targetid + ", event: " + e,
          "info",
          "body",
        );
        ...
        for (var i = 0; i < this.tgmapcoords.length; i++) {
          if (i == targetid) {
            ...
            YAHOO.log(
              "renderImageMap() - result img src: " + this.orgimg.src,
              "info",
              "ImagemapField.js",
            );
            break;
