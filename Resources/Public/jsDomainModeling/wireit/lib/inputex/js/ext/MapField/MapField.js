     ...
     */
    {
      ...
      setOptions: function (options) {
        ...
        this.options.className =
          options.className || "inputEx-Field inputEx-MapField";
        ...
        this.options.api_key =
          options.api_key || inputEx.MapFieldGlobals.api_key;
      },
      ...
      yahoo: {
        ...
        preload: function (superwrapper) {
          ...
          if (!inputEx.MapFieldGlobals.yahoo_preloader_error) {
            ...
            alert(
              "InputEx.MapField: we do not recommend dynamic API loading for Yahoo Maps",
            );
          }
          ...
          if (!inputEx[preloader]) {
            ...
            var api_key =
              superwrapper.options.api_key[window.location.hostname];
            if (!api_key) {
            ...
            script.src =
              "http://us.js2.yimg.com/us.js.yimg.com/lib/map/js/api/ymapapi_3_8_0_7.js";
            script.type = "text/javascript";
        ...
        onposition: function () {
          try {
            ...
            this._mapField.elUZoom.value =
              inputEx.MapFieldZoom.yahoo.to_universal(z);
          } catch (x) {
            alert(x);
          }
        },
      ...
      google: {
        ...
        create: function (superwrapper) {
          ...
          this.g_map.setCenter(
            new GLatLng(
              parseFloat(superwrapper.elLat.value),
              parseFloat(superwrapper.elLon.value),
            ),
        ...
        onposition: function () {
          try {
            ...
            this._mapField.elNZoom.value = z;
            this._mapField.elUZoom.value =
              inputEx.MapFieldZoom.google.to_universal(z);
          } catch (x) {
            alert(x);
          }
        },
      ...
      virtualearth: {
        ...
        create: function (superwrapper) {
          ...
          this.ve_map.LoadMap(
            ...
            inputEx.MapFieldZoom.virtual_earth.to_native(
              superwrapper.elUZoom.value,
            ),
            VEMapStyle.Road,
            false,
            VEMapMode.Mode2D,
        ...
        onposition: function (ve_map) {
          ...
          try {
            ...
            ve_map._mapField.elUZoom.value =
              inputEx.MapFieldZoom.virtual_earth.to_universal(z);
          } catch (x) {
