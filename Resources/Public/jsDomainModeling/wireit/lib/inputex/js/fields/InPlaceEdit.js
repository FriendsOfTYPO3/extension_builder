  ...
  lang.extend(
     ...
     */
    {
      ...
      setOptions: function (options) {
        ...
        this.options.animColors = options.animColors || {
          from: "#ffff99",
          to: "#ffffff",
        };
      ...
      renderEditor: function () {
        this.editorContainer = inputEx.cn(
          "div",
          { className: "inputEx-InPlaceEdit-editor" },
          { display: "none" },
        );
      ...
      onVisuMouseOut: function (e) {
        ...
        this.colorAnim = new YAHOO.util.ColorAnim(
          this.formattedContainer,
          { backgroundColor: this.options.animColors },
          1,
        );
        this.colorAnim.onComplete.subscribe(
          function () {
      ...
      renderVisuDiv: function () {
        ...
        if (lang.isFunction(this.options.formatDom)) {
          this.formattedContainer.appendChild(
            this.options.formatDom(this.options.value),
          );
        } else if (lang.isFunction(this.options.formatValue)) {
          this.formattedContainer.innerHTML = this.options.formatValue(
            this.options.value,
          );
        } else {
          this.formattedContainer.innerHTML = lang.isUndefined(
            this.options.value,
          )
            ? inputEx.messages.emptyInPlaceEdit
            : this.options.value;
        }
      ...
      onKeyUp: function (e) {
        ...
        var tmp = this.editorField.el.value
          .substr(1)
          .replace(/[^a-zA-Z0-9]/g, "");
      ...
      openEditor: function () {
        ...
        if (
          this.editorField.el &&
          lang.isFunction(this.editorField.el.setSelectionRange) &&
          !!value &&
          !!value.length
        ) {
      ...
      setValue: function (value, sendUpdatedEvt) {
        ...
        inputEx.InPlaceEdit.superclass.setValue.call(
          this,
          value,
          sendUpdatedEvt,
        );
