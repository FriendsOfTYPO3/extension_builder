     ...
     */
    {
      ...
      setOptions: function (options) {
        ...
        this.options.className = options.className
          ? options.className
          : "inputEx-Field inputEx-MenuField";

        // New options
        this.options.menuInvite =
          options.menuInvite || inputEx.messages.menuInvite;
      ...
      renderComponent: function () {
        ...
        this.el = inputEx.cn(
          "div",
          { className: "inputEx-Result" },
          null,
          this.options.menuInvite,
        );
        YAHOO.util.Dom.addClass(
          this.el,
          this.options.menuPosition[1] == "tr"
            ? "inputEx-RightArrow"
            : "inputEx-DownArrow",
        );
      ...
      initMenuItems: function () {
        ...
        function levelInit(conf, level) {
          if (level > 4)
            throw new Error(
              "MenuField : too much recursion, menuItems property should be 5 level deep at most.",
            );
      ...
      initMenu: function () {
        ...
        this.menu = new YAHOO.widget.Menu(YAHOO.util.Dom.generateId(), {
          context: context,
        });
      ...
      setValue: function (value, sendUpdatedEvt) {
        // update text
        this.el.innerHTML =
          this._textFromValue[value] || this.options.menuInvite;
