  ...
  YAHOO.util.Event.onDOMReady(function () {
    if (YAHOO.inputEx) {
      ...
      lang.extend(
         ...
         */
        {
          ...
          initEvents: function () {
            ...
            this.typeSelect.updatedEvt.subscribe(
              this.rebuildGroupOptions,
              this,
              true,
            );
          ...
          rebuildGroupOptions: function () {
            try {
              ...
              this.group.updatedEvt.subscribe(
                this.onChangeGroupOptions,
                this,
                true,
              );
              ...
              if (
                YAHOO.lang.isObject(window["console"]) &&
                YAHOO.lang.isFunction(window["console"]["log"])
              ) {
          ...
          updateFieldValue: function () {
            try {
              ...
              this.fieldValue.updatedEvt.subscribe(
                this.fireUpdatedEvt,
                this,
                true,
              );
          ...
          setValue: function (value, sendUpdatedEvt) {
            ...
            // Set field value
            if (
              lang.isObject(value.inputParams) &&
              typeof value.inputParams.value != "undefined"
            ) {
          ...
          getValue: function () {
            ...
            if (this.fieldValue)
              obj.inputParams.value = this.fieldValue.getValue();
      ...
      inputEx.Field.groupOptions = [
        {
          type: "string",
          inputParams: { label: "Label", name: "label", value: "" },
        },
        {
          type: "string",
          inputParams: { label: "Name", name: "name", value: "" },
        },
        {
          type: "string",
          inputParams: { label: "Description", name: "description", value: "" },
        },
        {
          type: "boolean",
          inputParams: { label: "Required?", name: "required", value: false },
        },
        {
          type: "boolean",
          inputParams: {
      ...
      inputEx.StringField.groupOptions =
        inputEx.StringField.superclass.constructor.groupOptions.concat([
          {
            type: "string",
            inputParams: {
              label: "Type invite",
          ...
          {
            type: "integer",
            inputParams: { label: "Size", name: "size", value: 20 },
          },
          {
            type: "integer",
            inputParams: { label: "Min. length", name: "minLength", value: 0 },
          },
        ]);

      if (inputEx.CheckBox) {
        inputEx.CheckBox.groupOptions =
          inputEx.CheckBox.superclass.constructor.groupOptions.concat([
            {
              type: "string",
              inputParams: { label: "Right Label", name: "rightLabel" },
            },
          ]);
      }
      ...
      if (inputEx.ColorField) {
        inputEx.ColorField.groupOptions =
          inputEx.ColorField.superclass.constructor.groupOptions.concat([]);
      }

      if (inputEx.DateField) {
        inputEx.DateField.groupOptions =
          inputEx.DateField.superclass.constructor.groupOptions.concat([
            {
              type: "select",
              inputParams: {
                label: "Date format",
                name: "dateFormat",
                selectOptions: ["m/d/Y", "d/m/Y"],
                selectValues: ["m/d/Y", "d/m/Y"],
              },
            },
          ]);
      }
      ...
      if (inputEx.CombineField) {
        inputEx.CombineField.groupOptions =
          inputEx.CombineField.superclass.constructor.groupOptions.concat([
            {
              type: "list",
              inputParams: {
                name: "fields",
      ...
      if (inputEx.EmailField) {
        inputEx.EmailField.groupOptions = [].concat(
          inputEx.StringField.groupOptions,
        );
      }
      ...
      if (inputEx.PasswordField) {
        inputEx.PasswordField.groupOptions =
          inputEx.PasswordField.superclass.constructor.groupOptions.concat([
            {
              type: "boolean",
              inputParams: {
      ...
      if (inputEx.RadioField) {
        inputEx.RadioField.groupOptions =
          inputEx.RadioField.superclass.constructor.groupOptions.concat([
            {
              type: "list",
              inputParams: {
                label: "Options",
            ...
            {
              type: "boolean",
              inputParams: { label: "Allow custom value", name: "allowAny" },
              value: false,
            },
          ]);
      }
      ...
      if (inputEx.RTEField) {
        inputEx.RTEField.groupOptions =
          inputEx.RTEField.superclass.constructor.groupOptions.concat([]);
      }

      if (inputEx.UrlField) {
        inputEx.UrlField.groupOptions =
          inputEx.UrlField.superclass.constructor.groupOptions.concat([
            {
              type: "boolean",
              inputParams: {
      ...
      if (inputEx.Textarea) {
        inputEx.Textarea.groupOptions =
          inputEx.Textarea.superclass.constructor.groupOptions.concat([
            {
              type: "integer",
              inputParams: { label: "Rows", name: "rows", value: 6 },
            },
            {
              type: "integer",
              inputParams: { label: "Cols", name: "cols", value: 23 },
            },
          ]);
      }
      ...
      if (inputEx.SelectField) {
        inputEx.SelectField.groupOptions =
          inputEx.SelectField.superclass.constructor.groupOptions.concat([
            {
              type: "list",
              inputParams: {
                name: "selectValues",
      ...
      if (inputEx.SliderField) {
        inputEx.SliderField.groupOptions =
          inputEx.SliderField.superclass.constructor.groupOptions.concat([
            {
              type: "integer",
              inputParams: { label: "Min. value", name: "minValue", value: 0 },
            },
            {
              type: "integer",
              inputParams: {
      ...
      if (
        inputEx.ListField &&
        typeof inputEx.ListField.superclass.constructor.groupOptions !=
          "undefined"
      ) {
        inputEx.ListField.groupOptions =
          inputEx.ListField.superclass.constructor.groupOptions.concat([
            {
              type: "string",
              inputParams: {
                label: "List label",
      ...
      if (inputEx.IntegerField) {
        inputEx.IntegerField.groupOptions =
          inputEx.IntegerField.superclass.constructor.groupOptions.concat([
      ...
      if (inputEx.NumberField) {
        inputEx.NumberField.groupOptions =
          inputEx.NumberField.superclass.constructor.groupOptions.concat([]);
      }
      ...
      if (inputEx.VectorField) {
        inputEx.VectorField.groupOptions = inputEx.Field.groupOptions.concat([
          {
            type: "integer",
            inputParams: { label: "Dimension", name: "dimension", value: 2 },
          },
          {
            type: "integer",
            inputParams: { label: "Size", name: "size", value: 3 },
          },
          {
            type: "list",
            inputParams: {
      ...
      inputEx.TypeField.groupOptions =
        inputEx.TypeField.superclass.constructor.groupOptions.concat([]);
      ...
      inputEx.Group.groupOptions = [
        ...
        {
          type: "boolean",
          inputParams: { label: "Collapsed", name: "collapsed", value: false },
        },
        {
          type: "list",
          inputParams: {
      ...
      if (inputEx.Form) {
        inputEx.Form.groupOptions =
          inputEx.Form.superclass.constructor.groupOptions.concat([
            {
              type: "list",
              inputParams: {
                label: "Buttons",
      ...
      if (inputEx.InPlaceEdit) {
        inputEx.InPlaceEdit.groupOptions =
          inputEx.InPlaceEdit.superclass.constructor.groupOptions.concat([
            {
              type: "type",
              inputParams: { label: "Editor", name: "editorField" },
            },
          ]);
      }
    } else {
