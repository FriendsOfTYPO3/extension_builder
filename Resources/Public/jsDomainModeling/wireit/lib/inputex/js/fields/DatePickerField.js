     ...
     */
    {
      ...
      setOptions: function (options) {
        ...
        this.options.calendar =
          options.calendar || inputEx.messages.defautCalendarOpts;
      },
      ...
      renderComponent: function () {
        ...
        this.oOverlay.hideEvent.subscribe(
          function () {
      ...
      renderCalendar: function () {
        ...
        if (inputEx.messages.shortMonths)
          this.calendar.cfg.setProperty(
            "MONTHS_SHORT",
            inputEx.messages.shortMonths,
          );
        ...
        if (inputEx.messages.weekdays1char)
          this.calendar.cfg.setProperty(
            "WEEKDAYS_1CHAR",
            inputEx.messages.weekdays1char,
          );
        if (inputEx.messages.shortWeekdays)
          this.calendar.cfg.setProperty(
            "WEEKDAYS_SHORT",
            inputEx.messages.shortWeekdays,
          );
        ...
        this.oOverlay.beforeShowEvent.subscribe(
