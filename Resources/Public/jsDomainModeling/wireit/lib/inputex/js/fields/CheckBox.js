     ...
     */
    {
      ...
      renderComponent: function () {
        ...
        this.hiddenEl = inputEx.cn("input", {
          ...
          value: this.el.checked ? this.checkedValue : this.uncheckedValue,
        });
       ...
       */
      onChange: function (e) {
        this.hiddenEl.value = this.el.checked
          ? this.checkedValue
          : this.uncheckedValue;
