     ...
     */
    {
      ...
      setOptions: function (options) {
        ...
        if (!this.options.datasource) {
          ...
          this.options.datasource.responseType =
      ...
      populateSelect: function (items) {
        ...
        for (var i = 0; i < items.length; i++) {
          this.addOption({
            ...
            option: items[i][this.options.labelKey],
          });
        }
      },
      ...
      setValue: function (value, sendUpdatedEvt) {
        ...
        for (var i = 0; i < this.options.datasource.liveData.length; i++) {
          if (
            value === this.options.datasource.liveData[i][this.options.valueKey]
          ) {
        ...
        inputEx.DSSelectField.superclass.setValue.call(
          this,
          value,
          sendUpdatedEvt,
        );
       ...
       */
      getValue: function () {
        return this.options.datasource.liveData[this.el.selectedIndex][
