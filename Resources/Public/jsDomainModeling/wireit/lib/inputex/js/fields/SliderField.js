  ...
  YAHOO.lang.extend(
     ...
     */
    {
      ...
      setOptions: function (options) {
        ...
        this.options.minValue = lang.isUndefined(options.minValue)
          ? 0
          : options.minValue;
        this.options.maxValue = lang.isUndefined(options.maxValue)
          ? 100
          : options.maxValue;

        this.options.displayValue = lang.isUndefined(options.displayValue)
          ? true
      ...
      renderComponent: function () {
        this.sliderbg = inputEx.cn("div", {
          ...
          className: "inputEx-SliderField-bg",
        });
        this.sliderthumb = inputEx.cn("div", {
          className: "inputEx-SliderField-thumb",
        });
        this.sliderbg.appendChild(this.sliderthumb);
        this.fieldContainer.appendChild(this.sliderbg);

        if (this.options.displayValue) {
          this.valueDisplay = inputEx.cn(
            "div",
            { className: "inputEx-SliderField-value" },
            null,
            String(this.options.minValue),
          );
      ...
      setValue: function (val, sendUpdatedEvt) {
        ...
        var percent =
          (Math.floor(v - this.options.minValue) * 100) / this.options.maxValue;
