  ...
  lang.extend(
     ...
     */
    {
      ...
      renderComponent: function () {
        ...
        this.colorEl = inputEx.cn(
          "div",
          { className: "inputEx-ColorField-button" },
          { backgroundColor: this.el.value },
        );
        ...
        // Create overlay
        this.oOverlay = new YAHOO.widget.Overlay(Dom.generateId(), {
          visible: false,
        });
      ...
      renderPalette: function () {
        ...
        this.colors =
          this.options.colors || this.setDefaultColors(defaultPalette);
        ...
        this.cellPerLine =
          this.options.cellPerLine ||
          Math.ceil(Math.sqrt((this.length * this.ratio[0]) / this.ratio[1]));
        ...
        var width =
          (this.cellWidth + 2 * this.cellMargin) * this.cellPerLine +
          (YAHOO.env.ua.ie == 6 ? 3 * this.overlayPadding : 0);
        var height =
          (this.cellHeight + 2 * this.cellMargin) * this.cellPerColumn +
          (YAHOO.env.ua.ie == 6 ? 3 * this.overlayPadding : 0);
      ...
      renderColorGrid: function () {
        ...
        for (var i = 0; i < this.length; i++) {
          var square = inputEx.cn(
            "div",
            { className: "inputEx-ColorField-square" },
            {
      ...
      setValue: function (value, sendUpdatedEvt) {
        ...
        inputEx.ColorField.superclass.setValue.call(
          this,
          value,
          sendUpdatedEvt,
        );
