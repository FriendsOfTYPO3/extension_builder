     ...
     */
    {
      ...
      setOptions: function (options) {
        ...
        this.options.className = options.className
          ? options.className
          : "inputEx-Field inputEx-CombineField";
      ...
      renderComponent: function () {
        ...
        for (var i = 0; i < this.options.fields.length; i++) {
          ...
          field.divEl.removeChild(
            field.divEl.childNodes[field.divEl.childNodes.length - 1],
          );
      ...
      renderField: function (fieldOptions) {
        ...
        YAHOO.util.Event.addBlurListener(
          fieldInstance.getEl(),
          this.onBlur,
          this,
          true,
      ...
      setValue: function (values, sendUpdatedEvt) {
        ...
        inputEx.CombineField.superclass.setValue.call(
          this,
          values,
          sendUpdatedEvt,
        );
