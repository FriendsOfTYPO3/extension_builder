...
The :file:`.gitignore` defines files and folders of the TYPO3 extension that
...
bundled in the `TYPO3 Core <https://github.com/TYPO3/typo3/tree/TYPO3_8-7/typo3/sysext/core/Tests>`__,
...
command line by following the many examples on the Internet.
