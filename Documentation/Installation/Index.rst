...
.. seealso::
   ...
   On pages ":doc:`Migrate to Composer (Composer mode) <t3install:MigrateToComposer/Index>`"
   and ":doc:`The Extension Manager (Legacy mode) <t3start:ExtensionManager/Index>`"
