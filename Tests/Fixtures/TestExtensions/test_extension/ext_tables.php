...
(static function() {
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addLLrefForTCAdescr('tx_testextension_domain_model_category', 'EXT:test_extension/Resources/Private/Language/locallang_csh_tx_testextension_domain_model_category.xlf');
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::allowTableOnStandardPages('tx_testextension_domain_model_category');
})();
